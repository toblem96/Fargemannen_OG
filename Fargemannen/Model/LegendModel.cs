...
namespace Fargemannen.Model
{
    internal class LegendModel
    {
        ...
        public static void VelgFirkant()
        {
            ...
            HandleSelectedPolyline(per.ObjectId);
        }


        private static void HandleSelectedPolyline(ObjectId polylineId)
        {
            Document doc = Application.DocumentManager.MdiActiveDocument;
            ...
            using (doc.LockDocument())
            {
                ...
                List<Intervall> activeIntervals = Intervall.intervallListe
        ...
        private void CreateColoredRectangle(Document doc, Database db, Transaction tr, Point3d start, Point3d end, Intervall interval)
        {
        ...
        private void InsertIntervalText(Document doc, Transaction tr, Point3d start, Point3d end, Intervall interval)
        {
            if (doc == null || tr == null)
            {
